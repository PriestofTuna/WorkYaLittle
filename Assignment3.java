 ...
 */
 ...
 //created account can equal any number of accounts, inputed username and inputed password
 ...
 while (select.equals(AccountType.Student) || select.equals(AccountType.Staff)){
 ...
 //The above is an unbreakable loop causing the user to have to restart the program
 }
 }
 }
